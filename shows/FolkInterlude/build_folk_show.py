...
SHUFFLE     = False  # Keep original track order
...
playlist = []
playlist.append({"title": f"~ {SHOW_NAME} ~", "file": f"{R2_BASE_URL}/{INTRO_FILE}"})
...
playlist.append({"title": "~ Onward Through the Fog ~", "file": f"{R2_BASE_URL}/{OUTRO_FILE}"})
